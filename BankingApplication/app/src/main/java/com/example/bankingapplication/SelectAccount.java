...
public class SelectAccount extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    // RecyclerView
    RecyclerView rc;
    SendToUserAdapter myAdapter;
    ...
    public void onUserClick(int position) {
        ...
        startActivity(new Intent(SelectAccount.this, HomeActivity.class));
        finish();
    }
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder_exitButton = new AlertDialog.Builder(SelectAccount.this);
        builder_exitButton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton ("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick (DialogInterface dialogInterface, int i) {
                        ...
                        values.put(dbHelper.COLUMN_FROM_NAME, fromUserAccountName);
                        values.put(dbHelper.COLUMN_TO_NAME, toUserAccountName);
                        values.put(dbHelper.COLUMN_STATUS, 0);
                        values.put(dbHelper.COLUMN_AMOUNT, transferAmount);

                        db.insert(dbHelper.TABLE_NAME, null, values);

                        Toast.makeText(SelectAccount.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(SelectAccount.this, HomeActivity.class));
                        finish();
                    }
    ...
    private void displayDatabaseInfo() {
        ...
        UserHelper us=new UserHelper(getApplicationContext());

        String[] projection = {
                us.COLUMN_USER_NAME,
                us.COLUMN_USER_ACCOUNT_BALANCE,
                us.COLUMN_USER_ACCOUNT_NUMBER,
                us.COLUMN_USER_PHONE_NO,
                us.COLUMN_USER_EMAIL,
                us.COLUMN_USER_IFSC_CODE,
        };

        Cursor cursor = db.query(us.TABLE_NAME,   // The table to query
        ...
        try {
            ...
            int phoneNoColumnIndex = cursor.getColumnIndex(us.COLUMN_USER_PHONE_NO);
            int emailColumnIndex = cursor.getColumnIndex(us.COLUMN_USER_EMAIL);
            int ifscCodeColumnIndex = cursor.getColumnIndex(us.COLUMN_USER_IFSC_CODE);
            int accountNumberColumnIndex = cursor.getColumnIndex(us.COLUMN_USER_ACCOUNT_NUMBER);
            int nameColumnIndex = cursor.getColumnIndex(us.COLUMN_USER_NAME);
            int accountBalanceColumnIndex = cursor.getColumnIndex(us.COLUMN_USER_ACCOUNT_BALANCE);
