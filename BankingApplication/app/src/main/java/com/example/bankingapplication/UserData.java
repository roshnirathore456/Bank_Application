...
public class UserData extends AppCompatActivity {
    ...
    private void enterAmount() {
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(com.example.bankingapplication.UserData.this);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mAmount.getText().toString().isEmpty()) {
                    ...
                    Intent intent = new Intent(com.example.bankingapplication.UserData.this, SelectAccount.class);
    ...
    private void transactionCancel() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(com.example.bankingapplication.UserData.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(com.example.bankingapplication.UserData.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                    }
