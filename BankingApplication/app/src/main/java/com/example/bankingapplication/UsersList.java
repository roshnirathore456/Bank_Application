...
public class UsersList extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        int phoneNoColumnIndex = cursor.getColumnIndex(db.COLUMN_USER_PHONE_NO);
        int emailColumnIndex = cursor.getColumnIndex(db.COLUMN_USER_EMAIL);
        int ifscCodeColumnIndex = cursor.getColumnIndex(db.COLUMN_USER_IFSC_CODE);
        int accountNumberColumnIndex = cursor.getColumnIndex(db.COLUMN_USER_ACCOUNT_NUMBER);
        int nameColumnIndex = cursor.getColumnIndex(db.COLUMN_USER_NAME);
        int accountBalanceColumnIndex = cursor.getColumnIndex(db.COLUMN_USER_ACCOUNT_BALANCE);
